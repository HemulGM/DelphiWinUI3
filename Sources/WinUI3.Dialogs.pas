...
type
  ...
  TDialogFontParams = WinUI3.Frame.Dialog.Font.TDialogFontParams;

  TDialogFontResult = WinUI3.Frame.Dialog.Font.TDialogFontResult;
  ...
  public //modal
    ...
    class function Show(Owner: TCustomForm; Params: TDialogFontParams): TDialogFontResult; overload;
...
class function TWinUIDialog.Show(Owner: TCustomForm; Params: TDialogFontParams): TDialogFontResult;
begin
  Result := TFormDialogs.Execute(Owner, Params);
end;
